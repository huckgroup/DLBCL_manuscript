...
fig1_node_info <- read_excel("output/network_visual/node_info2.xlsx")
```
...
write.csv(volc_HBL1, file = "output/network_visual/node_info_HBL1_StimvsPBS_PBSctrl.csv", row.names = F, na = "")
```
...
write.csv(volc_iSYK100, file = "output/network_visual/node_info_HBL1_iSYK100uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
...
write.csv(volc_iBTK100, file = "output/network_visual/node_info_HBL1_iBTK100uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
...
write.csv(volc_iNFkB100, file = "output/network_visual/node_info_HBL1_iNFkB100uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
```
...
write.csv(volc_iNFkB0.1, file = "output/network_visual/node_info_HBL1_iNFkB0.1uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
...
write.csv(volc_iNFkB1, file = "output/network_visual/node_info_HBL1_iNFkB1uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
...
write.csv(volc_iNFkB10, file = "output/network_visual/node_info_HBL1_iNFkB10uMvsDMSOctrl_StimOnly.csv", row.names = F, na = "")
```
...
write.csv(volc_iSYK100_stim, file = "output/network_visual/node_info_HBL1_iSYK100uM_EffectStimvsPBS.csv", row.names = F, na = "")
...
write.csv(volc_iBTK100_stim, file = "output/network_visual/node_info_HBL1_iBTK100uM_EffectStimvsPBS.csv", row.names = F, na = "")
...
write.csv(volc_iNFkB100_stim, file = "output/network_visual/node_info_HBL1_iNFkB100uM_EffectStimvsPBS.csv", row.names = F, na = "")
```
...
write.csv(fig1_DESe2_node_info, file = "output/network_visual/node_info_HBL1_all.csv", row.names = F, na = "")
```
...
ggsave(
  fig1,
  filename = "output/figures/main_fig1.pdf",
  width = 180,
  height = 160,
  units = "mm",
  dpi = 300
...
ggsave(
  fig1,
  filename = "output/figures/main_fig1.jpg",
  width = 180,
  height = 155,
  units = "mm",
  dpi = 300
...
ggsave(
  fig1_new,
  filename = "output/figures/main_fig1_new.pdf",
  width = 180,
  height = 175,
  units = "mm",
  dpi = 300
...
ggsave(
  fig1_new,
  filename = "output/figures/main_fig1_new.jpg",
  width = 180,
  height = 190,
  units = "mm",
  dpi = 300
...
fig2_node_info <- read_excel("output/network_visual/node_info2.xlsx")
```
...
*Corroboration of network-wide signaling disruptions with iSYK and iNFκB.*
...
write.csv(volc_stim, file = "output/network_visual/node_info_combi_ActvsBas.csv", row.names = F, na = "")
```
...
write.csv(volc_iBTK, file = "output/network_visual/node_info_combi_iBTKvsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_iSYK, file = "output/network_visual/node_info_combi_iSYKvsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_iNFkB, file = "output/network_visual/node_info_combi_iNFkBvsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_iBTKiSYK, file = "output/network_visual/node_info_combi_iBTKiSYKvsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_equal1, file = "output/network_visual/node_info_combi_equal1vsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_equal10, file = "output/network_visual/node_info_combi_equal10vsDMSOctrl.csv", row.names = F, na = "")
...
write.csv(volc_threeiSYK, file = "output/network_visual/node_info_combi_threeiSYKvsDMSOctrl.csv", row.names = F, na = "")
```
...
fig5_DESe2_node_info <- list(volc_stim, volc_iBTK, volc_iSYK, volc_iNFkB, volc_iBTKiSYK, volc_equal1, volc_equal10, volc_threeiSYK) %>%
  purrr::reduce(full_join)
write.csv(fig5_DESe2_node_info, file = "output/network_visual/node_info_combi_all.csv", row.names = F, na = "")
```
...
# ggsave(
#   fig,
#   filename = "output/figures/fig.pdf",
#   width = 6,
#   height = 3,
#   units = "in",
#   dpi = 300
...
ggsave(
  fig6_panelA_place,
  filename = "output/figures/main_fig6_place.jpg",
  width = 180,
  height = 75,
  units = "mm",
  dpi = 300
