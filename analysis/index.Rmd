...
This is the data analysis folder for the following manuscript:
...
[Figs main](y_paper_main.html): Main figures for the paper

[Figs suppl](z_paper_suppl.html): Supplementary figures for the paper

[Figs poster](x_poster_FASEB.html): Figures for the poster for the FASEB conference
...
-   [IDseq DS108 PCA](DS108_r_seq_pca.html): PCA exploration analysis of experiment DS108 with
